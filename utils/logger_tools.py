...
def set_args_and_logger(args, rank):
    ...
    """
    args_name_dir = args.root_path+args.out_root_path + "custom/" + args.name + "/"
    ...
    # if rank == 0:
    #     wandb.init(project=args.project, entity="sen99", dir=args.root_path+args.out_root_path, name=args.name[12:])
