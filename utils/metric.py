    ...
    def load_pose(self, pose, t_start, t_end, pose_fps, without_file=False):
        ...
        if without_file:
            for line_data_np in pose: #,args.pre_frames, args.pose_length
                # data_each_file.append(np.concatenate([line_data_np[27:33], line_data_np[36:39], line_data_np[108:114], line_data_np[117:120]],0))
                data_each_file.append(np.concatenate([line_data_np[54-6:63-6], line_data_np[154-6:163-6] ],0))
        else: 
